...
//Used the following line to input different parameters and trying them out without
//running 'make' each time:
...
int main()
{
  ...
  PID pid;
  double init_Kp = -0.1715756;//during setting of parameters: atof(argv[1]);
